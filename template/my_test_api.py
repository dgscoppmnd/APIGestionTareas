...
def test_crear_tarea_valida():
    """Prueba POST /tasks/ con datos válidos - Debe retornar 201"""
...
def test_crear_tarea_invalida():
    """Prueba POST /tasks/ con datos inválidos - Debe retornar 400/422"""
...
def test_obtener_tarea(task_id):
    """Prueba GET /tasks/{task_id} - Debe retornar 200"""
...
def test_obtener_tarea_inexistente():
    """Prueba GET /tasks/{task_id} con ID inexistente - Debe retornar 404"""
...
def test_marcar_completada(task_id):
    """Prueba PUT /tasks/{task_id}/completar - Debe retornar 200"""
...
def test_obtener_tareas_caducadas():
    """Prueba GET /tasks/caducadas - Debe retornar 200"""
...
def test_obtener_todas_tareas():
    """Prueba GET /tasks con filtros - Debe retornar 200"""
...
def test_obtener_estadisticas():
    """Prueba GET /tasks/estadisticas - Debe retornar 200"""
...
def test_eliminar_tarea(task_id):
    """Prueba DELETE /tasks/{task_id} - Debe retornar 204"""
